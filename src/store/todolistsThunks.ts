...
import {changeEntityStatusTodolist, changeFieldTodolistTitle} from "./todolists-reducer";
...
export const updateTodolistTitle = (todolistId: string, title: string): AppThunkActionType => async (dispatch) => {
