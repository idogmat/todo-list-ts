...
test('tasksReducer-add',()=>{
    let startState:TasksStateType={
        "todoListsId1": [{todoListId: '0',id:'222', title: "HTML&CSS", status: 0,addedDate:'1',order:0,startDate:'1',deadline:'2',description:'omg',priority:0,entityStatus: 'idle'},
            {todoListId: 'todoListsId2',id:'222', title: "HTML&CSS", status: 0,addedDate:'1',order:0,startDate:'1',deadline:'2',description:'omg',priority:0,entityStatus: 'idle'}
        ],
        'todoListsId2': [
            {todoListId: 'todoListsId2',id:'222', title: "HTML&CSS", status: 0,addedDate:'1',order:0,startDate:'1',deadline:'2',description:'omg',priority:0,entityStatus: 'idle'},
...
test('tasksReducer-change_title',()=>{
    let startState:TasksStateType={
        "todoListsId1": [{todoListId: '0',id:'333', title: "HTML&CSS", status: 0,addedDate:'1',order:0,startDate:'1',deadline:'2',description:'omg',priority:0,entityStatus: 'idle'},
            {todoListId: '0',id:'222', title: "HTML&CSS", status: 0,addedDate:'1',order:0,startDate:'1',deadline:'2',description:'omg',priority:0,entityStatus: 'idle'}
        ],
        'todoListsId2': [
